...
{
    internal class MonsterOne : AbstractMonster
    {
        public MonsterOne(Point panelCoordCell, Point mapC, Sizes sizes, List<Point> shortPath, int id) : base(sizes, shortPath, mapC, id, 10)
        {
            health = 100;
            numLoot = 100;
            speedMove = 1;
            ...
            string fName = "C://Users//banil//source//repos//IsometryTwo//IsometryTwo//Monsters//MobeOne//GoingFromMe.png";
            SaverPicture.ReadPicture(fName, modelUp, sizes.sizeMonsters.X, sizes.sizeMonsters.Y);
            fName = "C://Users//banil//source//repos//IsometryTwo//IsometryTwo//Monsters//MobeOne//GoingRight.png";
            SaverPicture.ReadPicture(fName, modelRight, sizes.sizeMonsters.X, sizes.sizeMonsters.Y);
            fName = "C://Users//banil//source//repos//IsometryTwo//IsometryTwo//Monsters//MobeOne//GoingLeft.png";
            SaverPicture.ReadPicture(fName, modelLeft, sizes.sizeMonsters.X, sizes.sizeMonsters.Y);
            fName = "C://Users//banil//source//repos//IsometryTwo//IsometryTwo//Monsters//MobeOne//GoingMe.png";
