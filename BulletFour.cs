...
{
    internal class BulletFour : AbstractBullet
    {
        public BulletFour(Sizes sizes, int type, Point panelCoordCell, int id, AbstractMonster monster) : base(type, id, 50, monster, sizes, 2)
        {
            string fName = null;

            fName = "C://Users//banil//source//repos//IsometryTwo//IsometryTwo//PictureBullets//imageBulletFour.png";
